...
#include "engine/entities/shapes/blade.h"
#include "engine/entities/shapes/hilt.h"
#include "engine/entities/shapes/shield.h"
#include "engine/entities/shapes/trim.h"
